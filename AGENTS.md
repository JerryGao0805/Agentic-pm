...
- Use openAI api for the AI calls. An OPENAI_API_KEY is in .env in the project root
- Use `openai/gpt-4o-mini` as the model
- Use Mysql local database for the database, creating a new db if it doesn't exist
